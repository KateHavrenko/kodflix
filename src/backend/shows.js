module.exports = function shows() {
    ...
    { id: 'friends', name: 'friends', description: `Friends is an American television sitcom, created by David Crane and
        Marta Kauffman, which aired on NBC from September 22, 1994, to May 6, 2004, lasting ten seasons` },
    { id: 'chernobyl', name: 'chernobyl',  description: `Chernobyl is a historical drama television miniseries created
    ...
    { id: 'biglittlelies', name: 'biglittlelies', description: `Big Little Lies is an American drama television series
    ...
    { id: 'blackmirror', name: 'blackmirror', description: `Black Mirror is a British science fiction anthology
    ...
    { id: 'outlander', name: 'outlander', description: `Outlander is a drama television series based upon author Diana 
